      ...
      <DashboardShell
        brand={
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              ...
              <div className="text-[11px] text-zinc-400">Inicio</div>
            </div>
          </div>
        }
        topNav={
          <div className="flex items-center gap-8 text-[13px]">
            <Link
              className="border-b-2 border-lime-400 pb-2 font-semibold text-lime-200"
              href="/"
            >
              Inicio
            </Link>

            <Link className="pb-2 text-zinc-200 hover:text-zinc-50" href="/#envivo">
              En Vivo
              <span className="ml-2 rounded-md bg-red-500/25 px-2 py-0.5 text-[10px] font-extrabold text-red-200 ring-1 ring-red-500/30">
                LIVE
              </span>
            </Link>
            <Link className="pb-2 text-zinc-200 hover:text-zinc-50" href="/#proximos">
              Próximos
            </Link>
            <Link className="pb-2 text-zinc-200 hover:text-zinc-50" href="/account">
              Mis Apuestas
            </Link>
            <Link className="pb-2 text-zinc-200 hover:text-zinc-50" href="/carton">
              Comprar Cartones
            </Link>
            <Link className="pb-2 text-zinc-200 hover:text-zinc-50" href="/cartones">
              Mis Cartones
            </Link>
            <a className="pb-2 text-zinc-200 hover:text-zinc-50" href="#stats">
              Estadísticas
            </a>
            <a className="pb-2 text-zinc-200 hover:text-zinc-50" href="#promo">
              Promociones
            </a>
          </div>
        }
        ...
        center={
          <div className="space-y-4">
            <Card className="border-zinc-800 bg-gradient-to-b from-zinc-900/40 to-zinc-950/40 p-6 shadow-[0_0_0_1px_rgba(24,24,27,0.55),0_20px_60px_rgba(0,0,0,0.45)]">
              <div className="flex items-center justify-between gap-4">
                <div>
                  <div className="text-[18px] font-extrabold">CARTONES MÁS COMPRADOS</div>
                ...
                <Link
                  href="/carton"
                  className="inline-flex items-center gap-2 rounded-2xl border border-zinc-800 bg-zinc-950/40 px-4 py-2 text-[13px] font-semibold text-lime-200 hover:bg-zinc-900"
                >
            ...
            <div className="grid gap-4 lg:grid-cols-3">
              ...
              {featuredCartonesFixed.map((c, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative p-5">
                        <div className="inline-flex items-center gap-2 rounded-xl bg-zinc-900/50 px-3 py-1 text-[11px] font-extrabold text-zinc-200 ring-1 ring-zinc-800">
                          🔒 BLOQUEADO
                        </div>
                        <div className="mt-3 text-[16px] font-extrabold text-zinc-200">{label}</div>
                        <div className="mt-2 text-[12px] text-zinc-500">Disponible próximamente</div>
                        ...
                        <div className="mt-4 grid gap-2 text-[12px] text-zinc-400">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <span className="font-semibold text-zinc-300">1 · X · 2</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <span>Deporte</span>
                            <span className="font-semibold text-zinc-300">Fútbol</span>
                          </div>
                        </div>
                      ...
                      <div className="grid grid-cols-[1fr_1fr] border-t border-zinc-800">
                        <div className="px-5 py-4 text-[13px] font-extrabold text-zinc-400 tabular-nums">
                          —
                        </div>
                        <button
                          type="button"
                          disabled
                          className="flex items-center justify-center gap-2 bg-zinc-900/50 px-5 py-4 text-[13px] font-extrabold text-zinc-500"
                        >
                          🛒 Comprar
                        </button>
                      </div>
                ...
                >
                  <div className="p-5">
                    {idx === 0 ? (
                      <div className="inline-flex items-center gap-2 rounded-xl bg-lime-500/15 px-3 py-1 text-[11px] font-extrabold text-lime-200 ring-1 ring-lime-500/25">
                        🔥 MÁS POPULAR
                      </div>
                    ) : null}

                    <div className="mt-3 text-[16px] font-extrabold text-zinc-50">
                      {c.title ? c.title : cartonTitle(c.type)}
                    </div>
                    <div className="mt-2 text-[12px] text-zinc-400">Fecha {c.number_date}</div>
                    ...
                    <div className="mt-4 grid gap-2 text-[12px] text-zinc-300">
                      <div className="flex items-center justify-between">
                        <span>Partidos</span>
                      ...
                      <div className="flex items-center justify-between">
                        <span>Opciones por partido</span>
                        <span className="font-semibold text-zinc-200">1 · X · 2</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span>Deporte</span>
                        <span className="font-semibold text-zinc-200">Fútbol</span>
                      </div>
                    </div>
                      ...
                      <div className="mt-6 border-t border-zinc-800 pt-4">
                        ...
                        <div className="mt-3 flex items-start gap-3">
                          <div className="flex flex-none items-center gap-2">
                            <div className="grid h-10 w-10 shrink-0 place-items-center overflow-hidden rounded-2xl bg-zinc-950/50 ring-1 ring-zinc-800">
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="text-[13px] font-semibold leading-snug text-zinc-200">
                              ...
                              <span className="mt-0.5 block text-[11px] font-semibold text-zinc-500 sm:hidden">
                                vs
                              </span>
                            </div>
                  ...
                  <div className="grid grid-cols-[1fr_1fr] border-t border-zinc-800">
                    <div className="px-5 py-4 text-[13px] font-extrabold text-zinc-200 tabular-nums">
                      $ {formatMoneyARS(c.price_ars)},00
                    </div>
                    <Link
                      href="/carton"
                      className="flex items-center justify-center gap-2 bg-lime-500/80 px-5 py-4 text-[13px] font-extrabold text-zinc-950 hover:bg-lime-500"
                    >
                      🛒 Comprar
                    </Link>
                  </div>
            ...
            <section id="envivo" className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Link className="text-[12px] text-lime-300 hover:underline" href="/bet">
                  Ver todos
                </Link>
              </div>
                  ...
                  <div className="flex gap-3 overflow-x-auto pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                    {matchesState.data.slice(0, 6).map((m, idx) => {
                      ...
                      return (
                        <Card
                          key={`${a}-${b}-${idx}`}
                          className="min-w-[300px] border-zinc-800 bg-gradient-to-b from-zinc-900/40 to-zinc-950/40 p-4"
                        >
                          ...
                          <div className="mt-4 grid grid-cols-[minmax(0,1fr)_64px_minmax(0,1fr)] items-center">
                            <div className="flex min-w-0 flex-col items-center gap-2">
                              <div className="grid h-12 w-12 place-items-center overflow-hidden rounded-full bg-zinc-950/60 ring-1 ring-zinc-800">
                              ...
                              <div className="w-full truncate text-center text-[12px] font-semibold text-zinc-200">
                                {a}
                              </div>
                            </div>

                            <div className="text-center text-2xl font-extrabold tabular-nums text-zinc-50">
                              <span>0</span>
                          ...
                          <div className="mt-4 grid grid-cols-3 gap-2">
                            {[
                              ...
                              <div
                                key={o.k}
                                className="rounded-2xl border border-zinc-800 bg-zinc-950/60 px-3 py-2 text-center"
                              >
                                <div className="text-[10px] text-zinc-500">{o.k}</div>
                                <div className="mt-0.5 text-[13px] font-extrabold tabular-nums text-lime-300">
                                  {o.v}
                                </div>
                              </div>
                            ))}
            ...
            <div className="grid gap-3 rounded-3xl border border-zinc-800 bg-zinc-950/30 p-5 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div key={x.t} className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-[12px] font-extrabold text-zinc-200">{x.t}</div>
                    <div className="mt-0.5 text-[11px] text-zinc-500">{x.d}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        right={
          <div className="space-y-4">
            <Card className="border-zinc-800 bg-gradient-to-b from-zinc-900/40 to-zinc-950/40 p-5">
              <div className="text-[13px] font-extrabold text-zinc-200">TU CARTÓN ACTUAL</div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-3 border-t border-zinc-800 pt-4 text-[12px]">
                <div>
                  ...
                  <div className="mt-1 font-extrabold text-lime-300 tabular-nums">3</div>
                </div>
                <div>
                  <div className="text-zinc-400">Posición actual</div>
                  <div className="mt-1 font-extrabold text-lime-300 tabular-nums">1.342°</div>
                  <div className="text-[11px] text-zinc-500">de 12.568</div>
                </div>
              </div>
              <Link
                href="/carton"
                className="mt-5 inline-flex w-full items-center justify-center rounded-2xl bg-lime-500/80 px-4 py-3 text-[13px] font-extrabold text-zinc-950 hover:bg-lime-500"
              >
                Ver mi cartón
              </Link>
            </Card>
            ...
            <Card className="border-zinc-800 bg-gradient-to-b from-zinc-900/40 to-zinc-950/40 p-5">
              <div className="text-[13px] font-extrabold text-zinc-200">PRÓXIMOS CIERRES</div>
              <div className="mt-4 space-y-3">
                {featuredCartones.length ? (
                  featuredCartones.map((c) => (
                    <div
                      key={`${c.type}-${c.number_date}`}
                      className="flex items-center justify-between gap-3 rounded-2xl border border-zinc-800 bg-zinc-950/30 px-3 py-3"
                    >
                      <div>
                        <div className="text-[13px] font-semibold text-zinc-200">
                          {cartonTitle(c.type)}
                        </div>
                        <div className="text-[11px] text-lime-300">
                      ...
                      <Link
                        href="/carton"
                        className="rounded-2xl bg-lime-500/15 px-4 py-2 text-[12px] font-extrabold text-lime-200 ring-1 ring-lime-500/25 hover:bg-lime-500/20"
                      >
                        Comprar
                      </Link>
                    </div>
              ...
              <Link
                href="/carton"
                className="mt-4 inline-flex w-full items-center justify-center rounded-2xl border border-zinc-800 bg-zinc-950/50 px-3 py-2 text-[12px] font-semibold text-lime-200 hover:bg-zinc-900"
              >
            ...
            <Card className="border-zinc-800 bg-gradient-to-br from-lime-500/10 to-zinc-900/30 p-5">
              ...
              <p className="mt-2 text-[13px] text-zinc-300">Cuotas mejoradas todos los días</p>
              <Link
                href="/bet"
